...
module uart_regs_reg_top (
  input clk_i,
  input rst_ni,
  input  tlul_pkg::tl_h2d_t tl_i,
  output tlul_pkg::tl_d2h_t tl_o,
  // To HW
  output uart_reg_pkg::uart_regs_reg2hw_t reg2hw, // Write
  input  uart_reg_pkg::uart_regs_hw2reg_t hw2reg, // Read
  ...
  always_comb begin
    wr_err = (reg_we &(
               (addr_hit[ 0] & (|(UART_REGS_PERMIT[ 0] & ~reg_be))) |
               (addr_hit[ 1] & (|(UART_REGS_PERMIT[ 1] & ~reg_be))) |
               (addr_hit[ 2] & (|(UART_REGS_PERMIT[ 2] & ~reg_be))) |
               (addr_hit[ 3] & (|(UART_REGS_PERMIT[ 3] & ~reg_be))) |
               (addr_hit[ 4] & (|(UART_REGS_PERMIT[ 4] & ~reg_be))) |
               (addr_hit[ 5] & (|(UART_REGS_PERMIT[ 5] & ~reg_be))) |
               (addr_hit[ 6] & (|(UART_REGS_PERMIT[ 6] & ~reg_be))) |
               (addr_hit[ 7] & (|(UART_REGS_PERMIT[ 7] & ~reg_be))) |
               (addr_hit[ 8] & (|(UART_REGS_PERMIT[ 8] & ~reg_be))) |
               (addr_hit[ 9] & (|(UART_REGS_PERMIT[ 9] & ~reg_be))) |
               (addr_hit[10] & (|(UART_REGS_PERMIT[10] & ~reg_be))) |
               (addr_hit[11] & (|(UART_REGS_PERMIT[11] & ~reg_be))) |
               (addr_hit[12] & (|(UART_REGS_PERMIT[12] & ~reg_be)))));
  end
